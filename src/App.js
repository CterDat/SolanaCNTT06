...
import BookingHistory from './components/BookingHistory/BookingHistory'; // Import component lịch sử đặt vé
    ...
    <Router>
      ...
      <div className="custom-container mt-4">
        ...
        <Routes>
          ...
          <Route path="/categories/:category" element={<Category walletAddress={walletAddress} />} />
          <Route path="/add-movie" element={<AddMovie />} /> {/* Thêm route mới */}
          <Route path="/register" element={<Register />} /> {/* Route cho đăng ký */}
          <Route path="/login" element={<Login onLoginSuccess={(loggedInUser) => setUser(loggedInUser)} />} /> {/* Route cho đăng nhập */}
