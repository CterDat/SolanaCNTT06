                ...
                <nav className="navbar navbar-default navbar-custom">
                    ...
                    <div className="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
                        <ul className="nav navbar-nav flex-child-menu menu-left">
                            ...
                            <li className="">
                                <Link to={`/categories/kinh-di`} style={{backgroundColor:'#a9a9a9', border:'none'}} className="btn btn-secondary btn-large">kinh di</Link>
                            </li>
                            <li className="">
                                <Link to={`/categories/trinh-tham`} style={{backgroundColor:'#a9a9a9', border:'none'}} className="btn btn-secondary btn-large">Trinh thám</Link>
                            </li>
                            <li className="">
                                <Link to={`/categories/hoat-hinh`} style={{backgroundColor:'#a9a9a9', border:'none'}} className="btn btn-secondary btn-large">Hoạt hình</Link>
                            </li>
